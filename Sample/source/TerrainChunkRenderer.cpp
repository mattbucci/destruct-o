...
void TerrainChunkRenderer::HotChunk::Set(TerrainChunk * chunk, GLTerrainProgram * shader)
{
	...
	// Bind the vertex array object for this chunk
	glBindVertexArray ( vertexArrayBuffer );
    
    // Upload the indices for the terrain chunk
	...
	// Upload the vertex data for the terrain chunk
	...
	glVertexAttribPointer ( shader->AttributeMaterial(), 1, GL_UNSIGNED_SHORT, GL_FALSE, sizeof(TerrainChunk::ChunkVertexData), (void*)offsetof(TerrainChunk::ChunkVertexData,Material) );
